data = [
    ...
    ["Jaké druhy zvířat jsou ohroženy v důsledku degradace říčního prostředí?", "Několik ohrožených druhů, například lososa atlantického a vydru říční.", "Hady a pavouci", 1],
    ["Jak mohou místní komunity přispět k ochraně ekosystémů řek?", "Ignorováním ekologických problémů řek.", "Zapojením se do dobrovolnických činností, osvětovou prací a podporou udržitelného využívání říčních zdrojů", 1],
]
